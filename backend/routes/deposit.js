...
const getCompanyAddresses = () => {
  const addresses = {
    BSC: process.env.BSC_WALLET_ADDRESS || "0x651c00d3acd3393034af1c8b2baf95f776f4b6bd",
    POLYGON: process.env.POLYGON_WALLET_ADDRESS || "0x651c00d3acd3393034af1c8b2baf95f776f4b6bd"
  };
...
router.get('/usdt/addresses', authenticateToken, async (req, res) => {
  try {
    ...
    const addresses = {
      ...
      ERC20: process.env.USDT_ERC20_ADDRESS || '0x651c00d3acd3393034af1c8b2baf95f776f4b6bd',
...
router.get('/company-addresses', authenticateToken, async (req, res) => {
  try {
    ...
    const addresses = {
      ...
      BEP20: process.env.BSC_WALLET_ADDRESS || '0x651c00d3acd3393034af1c8b2baf95f776f4b6bd',
      ERC20: process.env.ETH_WALLET_ADDRESS || '0x651c00d3acd3393034af1c8b2baf95f776f4b6bd',
      POLYGON: process.env.POLYGON_WALLET_ADDRESS || '0x651c00d3acd3393034af1c8b2baf95f776f4b6bd'
    };
